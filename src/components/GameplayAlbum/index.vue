...
<style scoped>
@font-face { font-family: GaGilroy; src: url('@/assets/endfield/gameplay-album/gilroy-medium.woff2'); } @font-face { font-family: GaNovecento; src: url('@/assets/endfield/gameplay-album/novecento-medium.woff2'); } @font-face { font-family: GaNovecentoBold; src: url('@/assets/endfield/gameplay-album/novecento-bold.woff2'); }
